...
class AddressController extends Controller
{
    ...
    {
        $address = new Address();
        $form = $this->createForm('ContactBoxBundle\Form\AddressType', $address);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        //$editForm = $this->createForm('ContactBoxBundle\Form\AddressType', $address);
        
        $editForm = $this->createFormBuilder($address)
                ->setMethod("GET")
                ->add('city')
                ->add('street')
                ->add('house_number')
